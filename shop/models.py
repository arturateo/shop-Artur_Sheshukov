...
class Product(models.Model):
    title = models.CharField(max_length=50, null=False, blank=False, verbose_name='Наименование продукта')
    description = models.TextField(max_length=3000, null=True, blank=True, verbose_name='Описание продукта')
    ...
    balance = models.IntegerField(null=False, blank=False, default=1, verbose_name='Остаток товара на складе')
